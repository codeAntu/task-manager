         ...
         <section className='px-5 pt-5 text-sm'>
            ...
            <div className='flex flex-col gap-2'>
               <p className='indent-5'>
                  ...
                  <span className='text-accent'>codeAntu@gmail.com</span> . Any amount is appreciated, and it helps me
               ...
               <div className='aboutMe mt-10 flex flex-col items-center justify-center'>
                  <p className='text-xl font-medium'>Ananta</p>
                  <p>
                     <a href='mailto:codeAntu@gmail.com' className='text-base text-accent'>
                        codeAntu@gmail.com
                     </a>
                  </p>
               </div>
